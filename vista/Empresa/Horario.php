...
foreach ($horariosv2 as $dato) {
    ?>
                            <tr>
                                <td>
                                    <button class="btn btn-warning" onclick="location.href='../../models/Horarios/editar_horario.php?id=<?php echo $dato->id_horario; ?>'">
                                    ...
                                    <button class="btn btn-danger" onclick="location.href='../../models/Horarios/eliminar_horario.php?id=<?php echo $dato->id_horario; ?>'">
