...
require_once "../modals/new_dep.php";
  ?>
  ...
  <main class="page-content">
    <div class="container-fluid">
      <article>
            ...
            <button type="button" class="buttonlink" data-bs-toggle="modal" data-bs-target="#staticBackdrop" >+ Agregar departamento</button>
      </article><br/><br/><br/>
...
foreach ($departamentos as $dato) {
    ...
    ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-warning" onclick="location.href='../../models/Departamento/editar_departamento.php?id=<?php echo $id; ?>'">
                                    ...
                                    <!--------------------------botonalerat------------------------
                                    <button onclick="alerteliminar();" id="delete" data-id="<?=$id?>" ></button>-->

                                   <button class="btn btn-danger"  onclick="alerteliminar();" id="delete" data-id="<?=$id?>" > 
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  ...
  swal({
    title:"Estás a punto de eliminar un departamento" ,
