    ...
    ?>
                            <tr>
                                <td>
                                    ...
                                    <a href="../../models/Horarios/editar_horario.php?id=<?php echo $dato->id_horario; ?>" data-bs-toggle="modal2" data-bs-target="#exampleModal" data-bs-whatever="@mdo">
                                ...
                                <td><a href="../../models/Horarios/eliminar_horario.php?id=<?php echo $dato->id_horario; ?>">
